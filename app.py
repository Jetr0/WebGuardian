...
def check_all_requests():
    ...
    for key, value in request.args.items():
        if detect_sqli(value):
            stats['blocked_requests'] += 1
            write_log(f"SQLi detectado en parámetro URL '{key}': {value} desde {client_ip}", True)
...
def test(param):
    ...
    # Comprobar inyección en param (aunque el middleware global ya lo comprueba)
...
if __name__ == "__main__":
    ...
    print("=================================================")
    print("  SQLi-Shield: Protección contra SQL Injection   ")
    print("=================================================")
